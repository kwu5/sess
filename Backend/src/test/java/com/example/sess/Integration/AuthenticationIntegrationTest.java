// package com.example.sess.Integration;
...
// .andExpect(header().exists("Authorization")); // Assuming JWT is returned in
// the Authorization header
// // .andExpect(jsonPath("$.jwt").exists()); // Adjust this based on how your
// JWT
