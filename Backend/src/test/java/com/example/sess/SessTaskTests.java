...
// .with(jwt()
// .jwt(jwt -> jwt.claim("sub", "john")) // Set 'john' as the subject of the
// token
...
// // .value(containsInAnyOrder("2024-01-01 10:00:00", "2024-02-01 15:00:00")));
// // // admin
...
// // .andExpect(jsonPath("$..startTime").value(containsInAnyOrder("2024-01-01
// // 10:00:00",
// // "2024-02-01 15:00:00", "2024-04-01 19:00:00", "2024-03-01 10:00:00")));
// // }
...
// // Task taskToUpdate = new Task(null, "01/01/2024 10:30:00", "01/01/2024
// // 11:00:00",
...
// // Task taskToUpdate = new Task(null, "01/01/2024 10:30:00", "01/01/2024
// // 11:00:00",
// // 31L, 51L, "33 hl st, San Francisco, CA, 94444", "appointment", "happy
// day");
// // String taskJson = objectMapper.writeValueAsString(taskToUpdate);
